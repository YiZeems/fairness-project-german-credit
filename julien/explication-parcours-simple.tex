...
Perturb\'{e} & 0.7877 & 0.7048 & 0.0482 \\
$\Delta$ & $-0.0055$ & $+0.0036$ & $-0.0092$ \\
\bottomrule
\end{tabular}
\caption{D\'{e}gradation sous perturbation (seed 43).}
\end{table}

\begin{itemize}
    \item \textbf{Corr\'{e}lation des scores} : $r \approx 0.97$ entre scores clean et perturb\'{e}s.
    \item \textbf{D\'{e}gradation AUC} : moins d'1 point --- tr\`{e}s mod\'{e}r\'{e}e.
    \item \textbf{ECE} : l\'{e}g\`{e}rement r\'{e}duit (la perturbation a un effet de r\'{e}gularisation).
