...
\paragraph{Performance.} Le baseline V2 (régression logistique L2) atteint sur le test AUC = 0.785, balanced accuracy = 0.669 et average precision = 0.607, avec une convergence en 6 itérations. La matrice de coûts asymétrique documentée par UCI ($5 \cdot \text{FN} + 1 \cdot \text{FP}$) ancre le choix du seuil de classification dans la réalité bancaire.
